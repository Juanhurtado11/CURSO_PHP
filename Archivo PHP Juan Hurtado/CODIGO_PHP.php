...
?>
  <?php
  echo "<br>Somos una empresa a la banguardia de las tecnologias";
  ?>
  <?php
  echo "<br>A";
  echo "<br>B";
  echo "<br>C";
   ...
   <?php
   echo "<br>","<strong> Tenemos profesionales en todas las areas de infraestructura </strong>";
?>
<?php
  echo "<p>Somos tecnologia somos Neo Tec</p>";
  // This is a single-line comment
  echo "<p>Estamos a sus servicios</p>";
  echo "<p>Estamos para aportar al progreso</p>";
?>
<?php
  echo "<p>Piensa siempre en ser el mejor y nosotros te podemos ayudar</p>";
  /*
...
?>
<?php
define("Avianca", "Es uno de nuestros clientes", false);
echo "<br>";

// Outpusts "Es uno de nuestro clientes!"
?>

<?php
$string1 = "Avianca!"; //double quotes
$string2 = 'Es una de las mejores aerolineas';  //single quotes
...
if ($age<=13) {
  echo "<br>","<br>","Mostrando que es niño por qque es menor de 13","=", "child.";
...
<?php
require 'config.php';
echo '<img src="'.$image_path.'images" >';
?>
